...
path = Path("/tmp")
classes = ['unripe_peach','ripe_peach',
           'unripe_orange', 'ripe_orange',
           'unripe_banana', 'ripe_banana',
           'unripe_tomato', 'ripe_tomato',
           'unripe_lemon', 'ripe_lemon',
           'unripe_mango', 'ripe_mango']
...
def form(request):
    return HTMLResponse(
        """
        <h1>Ripe or Not</h1>
        <p>Find out if the fruit is ripe and ready to eat. Upload image or specify URL.</p><br>
